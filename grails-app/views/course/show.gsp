	...
	<body>
		...
		<div id="show-course" class="content scaffold-show" role="main">
			...
			<ol class="property-list course">
				...
				<g:if test="${courseInstance?.regClasses}">
				<li class="fieldcontain">
					<span id="regClasses-label" class="property-label"><g:message code="course.regClasses.label" default="Reg Classes" /></span>
					
						<g:each in="${courseInstance.regClasses}" var="r">
						<span class="property-value" aria-labelledby="regClasses-label"><g:link controller="regClass" action="show" id="${r.id}">${r?.encodeAsHTML()}</g:link></span>
						</g:each>
