			...
			<table>
				<thead>
					<tr>
						...
						<th><g:message code="registrationSheet.classReg.label" default="Class Reg" /></th>
				...
				<g:each in="${registrationSheetInstanceList}" status="i" var="registrationSheetInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${registrationSheetInstance.id}">${fieldValue(bean: registrationSheetInstance, field: "classReg")}</g:link></td>
