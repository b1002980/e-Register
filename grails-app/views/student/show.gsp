	...
	<body>
		...
		<div id="show-student" class="content scaffold-show" role="main">
			...
			<ol class="property-list student">
				...
				<g:if test="${studentInstance?.studt}">
				<li class="fieldcontain">
					<span id="studt-label" class="property-label"><g:message code="student.studt.label" default="Studt" /></span>
					
						<g:each in="${studentInstance.studt}" var="s">
						<span class="property-value" aria-labelledby="studt-label"><g:link controller="registerEntry" action="show" id="${s.id}">${s?.encodeAsHTML()}</g:link></span>
						</g:each>
