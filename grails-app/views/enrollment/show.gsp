	...
	<body>
		...
		<div id="show-enrollment" class="content scaffold-show" role="main">
			...
			<ol class="property-list enrollment">
				...
				<g:if test="${enrollmentInstance?.classEnroll}">
				<li class="fieldcontain">
					<span id="classEnroll-label" class="property-label"><g:message code="enrollment.classEnroll.label" default="Class Enroll" /></span>
					
						<span class="property-value" aria-labelledby="classEnroll-label"><g:link controller="regClass" action="show" id="${enrollmentInstance?.classEnroll?.id}">${enrollmentInstance?.classEnroll?.encodeAsHTML()}</g:link></span>
					
				</li>
				</g:if>
			
				<g:if test="${enrollmentInstance?.dateEnrolled}">
				<li class="fieldcontain">
					<span id="dateEnrolled-label" class="property-label"><g:message code="enrollment.dateEnrolled.label" default="Date Enrolled" /></span>
					
						<span class="property-value" aria-labelledby="dateEnrolled-label"><g:formatDate date="${enrollmentInstance?.dateEnrolled}" /></span>
